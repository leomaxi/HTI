                ...
                <div class="panel ">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="ti-layout-grid3"></i> User Groups
                        </h3>

                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="usergroupTbl">
                                <thead>
                                    <tr>
         ...
         <div id="userModal" class="modal fade animated" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form role="form" id="saveUserGroupForm">
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <label for="first-name">UserGroup</label>
...
<script src="{{ asset('js/usergroup.js')}}" type="text/javascript"></script>
