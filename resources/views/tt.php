...
<head>
    <meta charset="UTF-8">
    <title>Multiple File Uplaod | Clear Admin Template</title>
            ...
            <div id="menu" role="navigation">
                    ...
                    <div class="media profile-left">
                        ...
                        <div class="content-profile">
                            ...
                            <ul class="icon-list">
                                ...
                                <li><a href="lockscreen.html"> <i class="fa fa-fw ti-lock"></i> </a></li>
                                <li><a href="edit_user.html"> <i class="fa fa-fw ti-settings"></i> </a></li>
                                <li>
                                    <a href="login.html">
                                        <i class="fa fa-fw ti-shift-right"></i>
                                    </a>
                ...
                <ul class="navigation">
                    ...
                    <li class="menu-dropdown">
                        ...
                        <ul class="sub-menu">
                            <li>                                 <a href="menubarfold.html">                                     <i class="fa fa-fw ti-layout-menu-v"></i> Menubar Fold                                 </a>                             </li>                             <li>                                 <a href="horizontal_menu.html">                                     <i class="fa fa-fw ti-layout-menu-full"></i> Horizontal Menu                                 </a>                             </li>                             <li>                                 <a href="mini_sidebar.html">                                     <i class="fa fa-fw ti-control-backward"></i> Mini Sidebar                                 </a>                             </li>
                            <li>
